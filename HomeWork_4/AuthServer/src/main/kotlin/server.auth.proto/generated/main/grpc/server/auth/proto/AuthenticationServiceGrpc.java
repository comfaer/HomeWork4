...
public final class AuthenticationServiceGrpc {
  ...
  public static final String SERVICE_NAME = "server.auth.proto.AuthenticationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<server.auth.proto.AuthenticationRequest,
      server.auth.proto.AuthenticationResponse> getAuthenticateMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "authenticate",
      requestType = server.auth.proto.AuthenticationRequest.class,
      responseType = server.auth.proto.AuthenticationResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<server.auth.proto.AuthenticationRequest,
      server.auth.proto.AuthenticationResponse> getAuthenticateMethod() {
    io.grpc.MethodDescriptor<server.auth.proto.AuthenticationRequest, server.auth.proto.AuthenticationResponse> getAuthenticateMethod;
      ...
      synchronized (AuthenticationServiceGrpc.class) {
        if ((getAuthenticateMethod = AuthenticationServiceGrpc.getAuthenticateMethod) == null) {
          AuthenticationServiceGrpc.getAuthenticateMethod = getAuthenticateMethod =
              io.grpc.MethodDescriptor.<server.auth.proto.AuthenticationRequest, server.auth.proto.AuthenticationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "authenticate"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  server.auth.proto.AuthenticationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  server.auth.proto.AuthenticationResponse.getDefaultInstance()))
  ...
  public static abstract class AuthenticationServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void authenticate(server.auth.proto.AuthenticationRequest request,
        io.grpc.stub.StreamObserver<server.auth.proto.AuthenticationResponse> responseObserver) {
      ...
      return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
          .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                server.auth.proto.AuthenticationRequest,
                server.auth.proto.AuthenticationResponse>(
  ...
  public static final class AuthenticationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AuthenticationServiceBlockingStub> {
    ...
    /**
     */
    public server.auth.proto.AuthenticationResponse authenticate(server.auth.proto.AuthenticationRequest request) {
  ...
  public static final class AuthenticationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AuthenticationServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<server.auth.proto.AuthenticationResponse> authenticate(
        server.auth.proto.AuthenticationRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_AUTHENTICATE:
          serviceImpl.authenticate((server.auth.proto.AuthenticationRequest) request,
              (io.grpc.stub.StreamObserver<server.auth.proto.AuthenticationResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class AuthenticationServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return server.auth.proto.Authentication.getDescriptor();
    }
